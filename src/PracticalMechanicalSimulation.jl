...
include("common/EquationComponents.jl")
include("common/FrictionLaws.jl")

include("planar/PlanarAppliedForces.jl")
include("planar/PlanarDirectedDistances.jl")
include("planar/PlanarComponentAssembly.jl")
include("planar/PlanarCurveContacts.jl")
include("planar/PlanarEquationComponents.jl")
include("planar/PlanarFrictionForces.jl")
...
include("spatial/SpatialCurveContacts.jl")
